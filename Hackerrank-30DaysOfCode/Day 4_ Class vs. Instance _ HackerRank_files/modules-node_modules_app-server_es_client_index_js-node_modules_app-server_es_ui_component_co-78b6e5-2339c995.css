...
.cookie-banner-wrapper{z-index:700;padding:10px 60px;background:#13813a;color:#fff;font-weight:700;font-size:13px}.cookie-banner-wrapper .cookie-container{display:flex;align-items:center}.cookie-banner-wrapper .cookie-message{flex:1}.cookie-banner-wrapper .cookie-btn-wrapper{display:flex;justify-content:center}.cookie-banner-wrapper .cookie-link{border-bottom:1px dotted #fff;color:#fff}.cookie-banner-wrapper .ui-btn-secondary{height:30px;text-transform:uppercase;font-weight:700}.cookie-banner-wrapper .ui-text{color:#13813a}.show-cookie-banner .work-login{height:calc(100vh - 50px)}@media screen and (max-width:800px){.cookie-banner-wrapper{position:fixed;bottom:0;width:100%;padding:0}.cookie-btn-wrapper,.cookie-message{padding:10px}.show-cookie-banner{padding-bottom:60px}}

/*# sourceMappingURL=https://hrcdn.net/fcore/assets/sourcemaps/modules-node_modules_app-server_es_client_index_js-node_modules_app-server_es_ui_component_co-78b6e5-2339c995.css.map*/